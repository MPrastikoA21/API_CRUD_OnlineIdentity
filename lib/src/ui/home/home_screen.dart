                          ...
                          onPressed: () {
                            showDialog(
                                ...
                                builder: (context) {
                                  return AlertDialog(
                                    title: Text("Warning"),
                                    content: Text("Apakah Anda Yakin Ingin Menghapus Data Profil ${profile.name}?"),
                                    actions: <Widget>[
                                      FlatButton(
                                        child: Text("Iya"),
                                        onPressed: () {
                                          ...
                                          apiService.deleteProfile(profile.id).then((isSuccess) {
                                            if (isSuccess) {
                                              ...
                                              Scaffold.of(this.context)
                                                  .showSnackBar(SnackBar(content: Text("Hapus Data Berhasil")));
                                            } else {
                                              Scaffold.of(this.context)
                                                  .showSnackBar(SnackBar(content: Text("Hapus Data Gagal")));
                                            }
                                          });
                                        },
                                      ),
